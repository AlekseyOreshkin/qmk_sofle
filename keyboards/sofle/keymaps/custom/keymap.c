 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LCTR | LAlt |RAISE |LOWER | /Space  /       \Enter \  |LOWER |RAISE | RAlt | RCTR |
 *            |      |      |      |      |/       /         \      \ |      |      | RGui |      |
 *            `----------------------------------'           '------''---------------------------'
 */
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Esc  | PScr | Scrl | Paus |      | WLck |                    | Home | PUp  |  Up  | PDwn |  Ins | Bspc |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  | LAt  | LCtl |LShift| WScr | Caps |-------.    ,-------| End  | Left | Down | Rigth|  Del | Bspc |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
 * |Shift | Undo |  Cut | Copy | WPst | WSpc |-------|    |-------| LStr | PWrd | NWrd | LEnd |      | Shift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LCTR | LAlt |RAISE |LOWER | /Space  /       \Enter \  |LOWER |RAISE | RAlt | RCTR |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
